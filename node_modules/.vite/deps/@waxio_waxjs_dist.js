...
} from "./chunk-I4DUYXYI.js";
import {
  require_buffer,
  require_elliptic
} from "./chunk-DX7JCEQ5.js";
import {
  require_hash
} from "./chunk-4XN4SPBG.js";
import {
  __commonJS
...
// node_modules/eosjs/dist/eosjs-ecc-migration.js
var require_eosjs_ecc_migration = __commonJS({
  "node_modules/eosjs/dist/eosjs-ecc-migration.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ecc = void 0;
    ...
    exports.ecc = {
      ...
      sha256: function(data, resultEncoding, encoding) {
        ...
        if (resultEncoding !== void 0) {
          console.warn("Argument `resultEncoding` is deprecated");
        }
        return require_eosjs_key_conversions().sha256(data);
      }
    };
  }
});
    ...
    var WaxEventSource = class {
      constructor(waxSigningURL) {
        ...
        this.timeout = () => __awaiter(this, void 0, void 0, function* () {
          return new Promise((_, reject) => setTimeout(() => reject(new Error("Timeout")), 5e3));
        });
    ...
    var WaxSigningApi = class {
      ...
      proofWindow(nonce, type, description) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          return this.waxEventSource.onceEvent(referWindow, this.waxSigningURL, this.receiveVerfication.bind(this), void 0);
        });
      }
      loginViaWindow() {
        return __awaiter(this, void 0, void 0, function* () {
      ...
      signViaWindow(serializedTransaction, window2, noModify = false, feeFallback = true) {
        return __awaiter(this, void 0, void 0, function* () {
          const startTime = getCurrentTime();
...
var require_dist2 = __commonJS({
  "node_modules/@waxio/waxjs/dist/index.js"(exports) {
    ...
    var eosjs_ecc_migration_1 = require_eosjs_ecc_migration();
...
//# sourceMappingURL=@waxio_waxjs_dist.js.map
